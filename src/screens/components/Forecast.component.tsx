...
function ForecastComponent() {
  ...
  return (
    <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-md mx-auto">
      <h1 className="text-lg font-bold text-slate-400 mb-4">Forecast</h1>
      <div className="space-y-4">
        {forecastday.map((day) => (
          <div
            key={day.date_epoch}
            className="flex justify-between items-center space-x-4 p-4 bg-gray-900 rounded-md shadow-md"
          >
            ...
            <div className="flex gap-4  text-white  justify-end items-center">
